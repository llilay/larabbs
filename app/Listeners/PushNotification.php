...
class PushNotification
{
    ...
    /**
     * 逻辑很简单，当通知存入数据库后，也就是监听 eloquent.created: Illuminate\Notifications\DatabaseNotification 这个事件，
     * 如果用户已经有了 Jpush 的 registration_id，
     * 则使用 Jpush SDK 将消息内容推送到目标用户的 APP 中，
